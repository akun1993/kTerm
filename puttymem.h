 ...
 *
 * The _nm variants of the macro set the 'secure' flag in the
 ...
 * secure keys or passwords, it avoids the risk that a realloc that
...
void *safegrowarray(void *array, size_t *size, size_t eltsize,
                    size_t oldlen, size_t extralen, uint8_t secure);
